...
class Car {
  ...
  drive(distance) {
    ...
    let maxMiles = this.milesPerGallon * this.fill();
...
class Instructor extends Lambdasian{
    constructor(lambdaAttr){
      super(lambdaAttr);
      this.specialty = lambdaAttr.specialty;
      this.favLanguage = lambdaAttr.favLanguage;
      this.catchPhrase = lambdaAttr.catchPhrase;
    }
    demo(subject) {
...
class ProjectManager extends Instructor {
    constructor(pmLambda){
      super(pmLambda);
      this.gradClassName = pmLambda.gradClassName;
      this.favInstructor = pmLambda.favInstructor;
    }
    standUp(channel){
